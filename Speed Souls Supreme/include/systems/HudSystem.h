...
{
public:
	HudSystem(sf::RenderWindow & window, entityx::EntityManager& entityManager, entityx::EventManager& newEvent, std::shared_ptr<FontBank> font, std::shared_ptr<sf::View> view);

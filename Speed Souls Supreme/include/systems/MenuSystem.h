...
private:
	...
	// LB and RB textures
	std::shared_ptr<sf::Texture> m_A_ButtonTexture;
	std::shared_ptr<sf::Texture> m_B_ButtonTexture;
	// LB and RB rect
	std::shared_ptr<sf::RectangleShape> m_A_Rect;
	std::shared_ptr<sf::RectangleShape> m_B_Rect;
};
